    ...
    for x in h_space:
        ...
        for y in w_space:
            ...
            if gt:
                ...
                class_dict[int(label_idx)] = class_dict.get(int(label_idx), []) + [gt_index]
...
if __name__ == "__main__":
    ...
    case_dict_outpath = "/home/user01/aiotlab/nmduong/BoneTumor/RAW/REAL_WSIs/case_dict_256_case68.json"
    ...
    specific_images = [
        "slide-2024-08-31T13-05-02-R1-S17.png",
        "slide-2024-09-02T10-54-04-R1-S11.png",
        "slide-2024-09-02T13-16-21-R1-S24.png"
    ]
    ...
    for tcase in cases:
        ...
        for label_name in os.listdir(case_label_folder):
            ...
            if img_name not in specific_images: continue
            ...
            cut_image(label,
                ...
                outdir = "/home/user01/aiotlab/nmduong/BoneTumor/RAW/REAL_WSIs/training_data_256_case68",
                gt=True)
