python infer_full.py \
    ...
    --phase1_path '/home/user01/aiotlab/nmduong/BoneTumor/src/exp_cls_256_cls_retrain_with9_case68/UNI_lora_cls/_best.pt' \
    ...
    --outdir './infer/smooth_stacked_discrete_ensemble_ce/'