...
from model.bbdm.utils import extract, default
...
class BrownianBridgeModel_Pathology(nn.Module):
    def __init__(self, model_config):
        ...
        self.eta = model_params['eta'] if 'eta' in model_params else 1
        ...
        self.denoise_fn = UNetModel(**model_params['UNetParams'])
