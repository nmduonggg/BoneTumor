...
from .UNI_lora_resnet_multimag_old import UNI_lora_resnet_MultiMag
from .UNI_lora_multimag_ISBI import UNI_lora_multimag_ISBI
...
def create_model(opt):
    ...
    if opt['network_G']['which_model_G'] == 'uni_lora_multimag_ISBI':
        return UNI_lora_multimag_ISBI(opt['network_G']['out_nc'])
