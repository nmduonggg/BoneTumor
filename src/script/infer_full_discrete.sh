python infer_full.py \
    ...
    --phase2_path '/mnt/disk4/nmduong/Vin-Uni-Bone-Tumor/BoneTumor/BBDM2/results/PredIm-1-ysubx-concat-with9-discrete/BrownianBridge-Pathology/checkpoint/top_model_epoch_20.pth' \
    --labels_dir '/mnt/disk4/nmduong/Vin-Uni-Bone-/labels' \
    --images_dir '/mnt/disk4/nmduong/Vin-Uni-Bone-/images' \
    --outdir './infer/smooth_stacked_discrete/'