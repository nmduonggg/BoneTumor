...
from model import TransformerReorder, UNI_lora_multimag_ISBI
...
class DiscreteStackedDiffusionModel_multi(nn.Module):
    def __init__(self, option):
        super(DiscreteStackedDiffusionModel_multi, self).__init__()
        self.option=option
        self.phase1_classifier = UNI_lora_multimag_ISBI(option['network_G']['out_nc'])
